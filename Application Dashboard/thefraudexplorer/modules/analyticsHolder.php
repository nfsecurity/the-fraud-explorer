...
<center>
    <div class="content-graph">
        <div class="graph-insights">
            ...
            echo '<span class="fa fa-area-chart font-aw-color">&nbsp;&nbsp;</span><a href="modules/graphicData" data-toggle="modal" data-target="#graphicdata" href="#">Vertical analytics</a></div>';
    ...
    options: {
        ...
        onClick: function(e) {
            ...
            if (element.length > 0) {
                ...
                var url = "modules/analyticsGraphPoints.php?coordinates=" + data;
