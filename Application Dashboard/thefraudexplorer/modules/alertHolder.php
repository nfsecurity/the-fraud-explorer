...
if ($agent_decSQ != "all")
{
    ...
    {        
        ...
        echo '<span class="fa fa-pencil-square-o font-icon-color-green fa-padding"></span><a class="alert-phrase-viewer" href="modules/alertPhrases?id='.$result['_id'].'&idx='.$result['_index'].'" data-toggle="modal" data-target="#alert-phrases" href="#">'.$wordTyped.'</a>';
        echo '</td>';
        ...
        echo '<a class="false-positive" href="modules/alertMarking?regid='.$result['_id'].'&agent='.$agentId.'&index='.$result['_index'].'&type='.$result['_type'].'&urlrefer=singlealerts" data-toggle="modal" data-target="#alertMarking" href="#">';
...
else
{
    ...
    foreach ($alertData['hits']['hits'] as $result)
    {
        ...
        echo '<a class="false-positive" href="modules/alertMarking?regid='.$result['_id'].'&agent='.$agentId.'&index='.$result['_index'].'&type='.$result['_type'].'&urlrefer=allalerts" data-toggle="modal" data-target="#alertMarking" href="#">';
