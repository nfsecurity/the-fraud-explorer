...
function endpointInsightsT($location, $gender, $endpointEnc, $totalWordHits, $countPressure, $countOpportunity, $countRationalization, $score, $dataRepresentation, $endpointName)
{
    $endpointData = explode("@", $endpointName);
    $endpointDomainWithoutTLD = between('@', '.', "@".$endpointData[1]);
    $spaces = false;
    ...
    if ($location == "endPoints" || $location == "eventData") $toReturn = '<div class="gender-container"><img src="../images/'.$gender.'-user.svg" class="gender-image"></div>';
    
    if ($score == 0)
    {
        return $toReturn . '<span class="tooltip-custom" title="<div class=tooltip-container><div class=tooltip-title>Fraud Triangle Insights</div><div class=tooltip-row><div class=tooltip-item>Records stored</div><div class=tooltip-value>'.number_format($totalWordHits, 0, ',', '.').'</div></div><div class=tooltip-row><div class=tooltip-item>Events by pressure</div><div class=tooltip-value>'.$countPressure.'</div></div><div class=tooltip-row><div class=tooltip-item>Events by opportunity</div><div class=tooltip-value>'.$countOpportunity.'</div></div><div class=tooltip-row><div class=tooltip-item>Events by rationalization</div><div class=tooltip-value>'.$countRationalization.'</div></div><div class=tooltip-row><div class=tooltip-item>Fraud triangle score</div><div class=tooltip-value>'.round($score, 1).'</div></div><div class=tooltip-row><div class=tooltip-item>Data representation</div><div class=tooltip-value>'.round($dataRepresentation, 1).' %</div></div></div>"><span class="image-padding"><span class="fa fa-id-badge awfont-padding-right font-icon-color-gray"></span>'.($spaces == true ? $endpointData[0] : $endpointData[0].'@'.$endpointDomainWithoutTLD).'<br><span class="fa fa-chevron-right awfont-padding-right font-icon-color-gray"></span><p style="font-family: \'FFont-Bold\'; display: inline;"><b>'.$endpointData[1].'</b></p></span></a>'; 
    }
    else
    {
        return $toReturn . '<a class="tooltip-custom" style="color: #555;" href=eventData?nt='.$endpointEnc.' title="<div class=tooltip-container><div class=tooltip-title>Fraud Triangle Insights</div><div class=tooltip-row><div class=tooltip-item>Records stored</div><div class=tooltip-value>'.number_format($totalWordHits, 0, ',', '.').'</div></div><div class=tooltip-row><div class=tooltip-item>Events by pressure</div><div class=tooltip-value>'.$countPressure.'</div></div><div class=tooltip-row><div class=tooltip-item>Events by opportunity</div><div class=tooltip-value>'.$countOpportunity.'</div></div><div class=tooltip-row><div class=tooltip-item>Events by rationalization</div><div class=tooltip-value>'.$countRationalization.'</div></div><div class=tooltip-row><div class=tooltip-item>Fraud triangle score</div><div class=tooltip-value>'.round($score, 1).'</div></div><div class=tooltip-row><div class=tooltip-item>Data representation</div><div class=tooltip-value>'.round($dataRepresentation, 1).' %</div></div></div>"><span class="image-padding"><span class="fa fa-id-badge awfont-padding-right font-icon-color-gray"></span>'.($spaces == true ? $endpointData[0] : $endpointData[0].'@'.$endpointDomainWithoutTLD).'<br><span class="fa fa-chevron-right awfont-padding-right font-icon-color-gray"></span><p style="font-family: \'FFont-Bold\'; display: inline;"><b>'.$endpointData[1].'</b></p></span></a>';        
    }
}
