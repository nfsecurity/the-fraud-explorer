...
<div id="footer">
    ...
    <div class="logo-container">
        &nbsp;&nbsp;&nbsp;<span class="fa fa-cube fa-lg font-icon-color">&nbsp;&nbsp;</span>The Fraud Explorer</b> &reg; Realtime Fraud Triangle Analytics
    </div>
    <div class="helpers-container">
        ...
        <span class="fa fa-globe fa-lg font-icon-color">&nbsp;&nbsp;</span><a href="#" onclick="startTour()" style="color: white;">Take tour</a>&nbsp;&nbsp;&nbsp;&nbsp;
