...
VERSION=0.0.1
PRODUCT=BusinessAnalytics

echo "Application uninstalling process started"
# remove link to shorcut file
find "/Applications/BusinessAnalytics/bin/" -name "BusinessAnalytics-0.0.1" | xargs rm
LOGGEDINUSER=$(stat -f%Su /dev/console)
rm /Users/${LOGGEDINUSER}/Library/LaunchAgents/businessAnalytics.plist
rm /Applications/BusinessAnalytics/bin/businessAnalytics
rm /Applications/BusinessAnalytics/businessAnalytics.log
rm /Applications/BusinessAnalytics/etc/config.ini 
if [ $? -eq 0 ]
then
